...
import { getTareas, getTareaById, postTarea, putTarea, deleteTarea } from "../controllers/tarea.controllers.js";
...
router.delete('/:id_tarea', verifyToken, verifyRoles(['administrador']), deleteTarea)
